...
HD_PWD='C:/Users/yorbe/OneDrive - uantwerpen/opgave_7/opgave_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log opgave_7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source opgave_7.tcl -notrace
