...
HD_PWD='C:/Users/yorbe/OneDrive - uantwerpen/opgave_1/opgave_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log opgave_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source opgave_1.tcl -notrace
