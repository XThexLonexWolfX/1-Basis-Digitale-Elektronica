...
HD_PWD='C:/Users/yorbe/OneDrive - uantwerpen/opgave_4/opgave_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log opgave_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source opgave_4.tcl -notrace
