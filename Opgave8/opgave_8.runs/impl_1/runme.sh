...
HD_PWD='C:/Users/yorbe/OneDrive - uantwerpen/opgave_8/opgave_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log opgave_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source opgave_8.tcl -notrace
